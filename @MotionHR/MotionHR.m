classdef MotionHR
    ...
    methods
        ...
        function obj = analysisPipeline(obj)
            ...
            for i=obj.activities.id
                ...
                raw_polarHR  = obj.getDataForActivity(i, obj.hrData.polar);
                raw_fitbitHR = obj.getDataForActivity(i, obj.hrData.fitbit);
                raw_bandHR   = obj.getDataForActivity(i, obj.hrData.band2);
    ...
    methods (Access = private)
        ...
        function [frames, t_frames] = splitToFramesByTime(obj, input, frameLen, overlap) 
            ...
            while i_start < n
                t_start     = t(i_start);
                i_end       = find(t >= (t_start + frameLen), 1, 'first') - 1;
